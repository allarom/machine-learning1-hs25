...
tibble::tibble(
  metric = c("RMSE (log-price)", "R² (log-price)"),
...
In a Poisson GLM with a log link, coefficients are interpreted multiplicatively:
`exp(beta)` is the factor change in the expected count.
